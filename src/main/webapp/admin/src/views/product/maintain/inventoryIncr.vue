<template>
    <el-dialog :close-on-click-modal="false" title="增加库存" :visible="true" @close="$emit('close')">
        <el-form :model="formWarehousing" :rules="rules" ref="ruleForm">
            ...
            <el-form-item label="重量（公斤）" :label-width="formLabelWidth" prop="weight">
                <el-input v-model="formWarehousing.weight" type="text" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="类型" :label-width="formLabelWidth" prop="type">
                <el-select v-model="formWarehousing.type" placeholder="请选择分组">
                    <el-option v-for="(item,key) in wareHousesingListAdd" :label="item.name" :value="item.id" :key="key"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="新增库存数量" :label-width="formLabelWidth" prop="num">
