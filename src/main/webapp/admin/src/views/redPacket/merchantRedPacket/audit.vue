    ...
    <el-dialog :close-on-click-modal="false" title="添加 \ 修改 记录" :visible="true" @close="$emit('close')">
        <el-form :model="form" :rules="rules" ref="ruleForm">
            ...
            <el-form-item label="您的批语" :label-width="formLabelWidth">
                <el-input v-model="form.auditRemark" type="textarea" auto-complete="off"></el-input>
            </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
            <el-button @click="handlePass" type="success">审核通过</el-button>
            <el-button @click="handleReject" type="danger">审核驳回</el-button>
