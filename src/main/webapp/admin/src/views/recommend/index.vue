        ...
        <el-card shadow="none">
            ...
            <el-row class="list-con clearfix">
                <el-row class="mb20" :gutter="20">
                    ...
                    <el-col :span="16">
                        <el-button style="float: right;margin-left: 10px;" @click="handleAdd" v-if="G.permission['_product/recommend/insert']">添加记录</el-button>
                    </el-col>
                </el-row>
                <el-table :data="tableData" border @cell-click="cellClick">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <el-button
                                type="text"
                                v-if="G.permission['_product/recommend/update']"
                                @click.stop="handleEdit(scope.row)">编辑</el-button>
                            <el-button
                                type="text"
                                v-if="G.permission['_product/recommend/delete']"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 点击编辑按钮
            handleEdit(data) {
                if (!this.G.permission['_product/recommend/get']) {
            ...
            // 获取数据
            pagers() {
                if (!this.G.permission['_product/recommend/pages']) {
                    return this.$notify.error('没有权限');
                }
                const param = {
                    eventName: 'hot_sale',
