    ...
    <el-aside id="aside" width="220px" style="background-color: #1d73d0" height="auto">
        <div id="sidebar" class="sidebar" style="margin-top: 15%">
            <el-menu
                ...
                <router-link :to="{name: '/project/index'}"><el-menu-item  index="/project/index"><img class="menu-icon" :src="iconYonghu" /><span class="sidebar-title">包进度</span></el-menu-item></router-link>
                <router-link :to="{name: '/task/index'}"><el-menu-item  index="/task/index"><img class="menu-icon" :src="iconYonghu" /><span class="sidebar-title">供货明细</span></el-menu-item></router-link>
                <router-link :to="{name: '/school/index'}"><el-menu-item  index="/school/index"><img class="menu-icon" :src="iconYonghu" /><span class="sidebar-title">学校进度</span></el-menu-item></router-link>
